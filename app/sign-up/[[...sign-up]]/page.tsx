...
const features = [
  ...
  "Invite collaborators to your canvas",
  "Generate specs from your system design",
];
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <h1 className="mt-3 text-3xl font-semibold tracking-tight text-copy-primary">
                    Bring your system designs to life.
                  </h1>
                </div>

                <p className="text-base leading-7 text-copy-secondary">
                  Structure ideas, collaborate in real time, and turn the final
                  graph into a reusable technical specification.
                </p>
